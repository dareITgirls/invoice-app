export const Button = (props) => {
  const baseStyles =
    'rounded-full p-4 text-md/1 md:px-6 focus:outline-none focus:border-primary-100 focus:border-2 transition duration-300';
  let buttonStyles;
  ...
  return (
    ...
    <button className={`${props.styles} ${buttonStyles}`} {...props}>
      {props.children}
      {props.title}
    </button>
  );
