...
export const ErrorPage = ({ error }) => {
  ...
  if (
    ...
    error.message === 'there was a problem with authentication, try again' ||
    error.message === 'there was a problem with fetching invoices, try again'
  ) {
    ...
    <PageContentWrapper>
      <MainContentWrapper styles="lg:w-2xl">
        ...
        <div className="flex flex-col items-center justify-between gap-6 font-bold text-center h-screen">
          <h1 className="text-lg dark:text-light-100 mt-8 md:text-4xl md:mt-20">
            Oups!
          </h1>
