...
export const AlertModal = ({ children, invoiceId }) => {
	...
	const styles = "flex flex-col gap-3 absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 max-w-[30rem] shadow-3xl bg-light-100 dark:bg-dark-200 p-4 md:p-12 rounded-lg z-20"

	return (
			<Modal className={styles} handleDiscard={handleDiscard} modalStatus={modalStatus}>
				<h2 autoFocus
