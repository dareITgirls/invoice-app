...
export const FooterNewInvoice = () => {
    ...
    return (
        <footer className="flex items-center justify-between rounded-xl w-[88%] bg-white dark:bg-dark-300 fixed md:w-[72.8%] md:pr-[56px] bottom-0 pb-4 lg:static lg:w-full lg:pr-0 lg:mt-0 lg:mb-3">
