...
export const NewInvoice = () => {
    ...
    return (  
        <Modal>  
            ...
            <h1 className="text-dark-400 dark:text-neutral-200 text-lg pt-8 pl-6 md:text-lg md:pt-16 md:pl-13.5 lg:pt-16">New Invoice</h1>
                <Formik
                ...
                {({ errors, touched }) => (
                    <Form action="POST" className="p-6 md:pt-12.5 md:pl-13.5 md:pr-14 lg:pr-14">
                        <BillFrom />
                        <BillTo />
                        <ItemList />
                        <Footer />
