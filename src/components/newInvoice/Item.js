    ...
    return (
        <li className="pb-5 md:flex md:w-full md:pb-4">
            ...
            <div className='flex flex-row items-center space-x-4'>
                ...
                <button type="button" onClick={() => deleteItemHandler(index)} className='pt-2 px-2 mt-6 md:pr-0 md:pl-6 md:mt-3'><img className="w-7 md:w-4" src={ASSETS_LIBRARY.icons.delete} /></button>
            </div>
        </li >
    )
}