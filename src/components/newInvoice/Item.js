...
export const Item = (props) => {
    ...
    const { classesInput, classesLabel } = useErrorDisplay(itemName);
    ...
    return (
        <li className="pb-5 md:flex md:w-full md:pb-4">
            ...
            <div className='flex flex-row items-center space-x-4 w-full'>
                <ItemInput name={itemQty} id="Qty" label="Qty." type="number" onBlur={handleBlur}  classes="w-2.6/5 md:w-1/5 lg:w-1/4"/>
                <ItemInput name={itemPrice} id="price" label="Price" type="number" onBlur={handleBlur} classes="w-4.3/5 md:w-2.3/5 lg:w-2.8/5"/>
