    ...
    return (
        <li className="pb-5 md:flex md:w-full md:pb-4 md:mt-[-20px]">
            ...
            <div className='flex flex-row items-center space-x-4 w-full'>
                <NoLabelInput name={`items[${index}].quantity`} id="Qty" label="Qty." type="number" onBlur={handleBlur}  classes="w-2.6/5 md:w-1/5 lg:w-1/4"/>
                <NoLabelInput name={`items[${index}].price`} id="price" label="Price" type="number" onBlur={handleBlur} classes=" w-4.3/5 md:w-2.3/5 lg:w-2.8/5"/>
