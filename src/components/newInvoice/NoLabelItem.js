    ...
    return (
        <li className="pb-5 md:flex md:w-full md:pb-4 md:mt-[-20px]">
            ...
            <div className='flex flex-row items-center space-x-4 w-[100%]'>
                <NoLabelInput name={`items[${index}].quantity`} id="Qty" label="Qty." type="number" onBlur={handleBlur}  classes="w-[56%] md:w-[20%]"/>
                <NoLabelInput name={`items[${index}].price`} id="price" label="Price" type="number" onBlur={handleBlur} classes=" w-[85%] md:w-[46%]"/>
