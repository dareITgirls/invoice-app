...
const Nav = () => {
	return (
		<header className='flex justify-between bg-dark-200'>
			<div className='relative bg-primary-200 w-18 h-18 flex items-center justify-center rounded-r-2xl after:absolute after:h-1/2 after:bg-primary-100 after:w-full after:bottom-0 after:rounded-tl-2xl after:rounded-br-2xl'>
				<svg className="z-10" xmlns='http://www.w3.org/2000/svg' width='28' height='26'>
					<path
						fill='#FFF'
						fillRule='evenodd'
			...
			<nav>
				<div className='flex items-center justify-center h-full px-6 divide-x divide-dark-600'>
					<button className='pr-6 h-full'>
						<svg width='20' height='20' xmlns='http://www.w3.org/2000/svg' className='dark:hidden'>
							<path
					...
					<button aria-label='User account' title='User account' className='pl-6 h-full'>
						<img className="rounded-full h-8 w-8" src={imageAvatar} alt='User' />
					</button>
				</div>
			</nav>
		</header>
