...
const Nav = () => {
	return (
		<header className='flex justify-between bg-dark-200 w-full lg:h-screen lg:w-fit lg:flex-col lg:rounded-r-2xl'>
				...
				<button className='px-6 h-full md:px-8 lg:py-8' type='button' aria-label='Switch color theme'>
					<svg className='dark:hidden' width='20' height='20' xmlns='http://www.w3.org/2000/svg'>
						...
						<path
							...
							fill='#7E88C3'
							fillRule='nonzero'
							className='hover:fill-neutral-200 transition duration-300'
						/>
					</svg>
